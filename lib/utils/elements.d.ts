...
export declare const createAutowidthTransformationSet: (el: any) => TransformationSetItem[];
export declare const createDefaultTransformationSet: (children: unknown[], galleryWidth: number, itemsInSlide: number) => TransformationSetItem[];
